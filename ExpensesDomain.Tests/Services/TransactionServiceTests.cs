...
namespace ExpensesDomain.Tests.Services
{
    ...
    public class TransactionServiceTests
    {
        ...
        private Mock<IApplicationUserRepository> userRepository;
        ...
        public void GetSummaryForUser_PaidExpenses_SentThreeTransfersToTwoUsersOneReceived()
        {
            ...
            expensesRepository
                ...
                .Returns(new List<Expense>
                {
                    new Expense
                    { 
                        Amount = 30, UserPayingId = currentUser, Participants = new List<ApplicationUser>
                        {
                            new ApplicationUser { Id = currentUser },
                            new ApplicationUser { Id = otherUser1 },
                            new ApplicationUser { Id = otherUser2 }
                        }
                    }
                });
        ...
        public void GetSummaryForUser_PaidExpensesAndReceived_SentThreeTransfersToTwoUsersOneReceived()
        {
            ...
            expensesRepository
                ...
                .Returns(new List<Expense>
                {
                    ...
                    new Expense 
                    { 
                        Amount = 75, UserPayingId = otherUser1, Participants = new List<ApplicationUser> 
                        {
                            new ApplicationUser { Id = currentUser },
                            new ApplicationUser { Id = otherUser1 },
                            new ApplicationUser { Id = otherUser2 }
        ...
        public void AddExpense()
        {
            var groupId = 1;
            var userId = "user";
            var group = new Group { GroupId = groupId, Members = new List<ApplicationUser> { new ApplicationUser { Id = userId } } };
        ...
        public void EditExpense_TheSameGroup()
        {
            ...
            userRepository.Setup(x => x.GetUser(It.IsAny<string>())).Returns(new ApplicationUser { Id = "1" });
